...
<head>
  ...
  <title>Application Art Page</title>
</head>
<body>
...
<main>
  ...
  <div class="search-area">
      <span class="search-icon" style="padding-top: 5px;"><i class="fas fa-search" style="color: #b1b1b1;"></i></span>
      <input type="search" name="search" value="<?php if(isset($_GET['search'])){echo $_GET['search'];}?>"class="form-control"  placeholder="Search Art">
  </div>
  </form>
</main>
  ...
  <div class="container">
    ...
    <?php
        ...
        $query="SELECT * FROM arts where user_id ='$_SESSION[id]'and status= 'Available'";
          ...
          if($check_images>0){
           ...
           ?>   
              ...
              <div class="overlay">
                ...
                <a href="apply.php?artID=<?php echo $row['artID']  ?>" style="text-decoration:none;"><button>Select For Application</button></a>
                </div>
            </div>
          </div>
    <?php
