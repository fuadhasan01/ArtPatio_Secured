...
<!-- Ends Nav code -->
  ...
  <div class="container">
    ...
    <?php
        ...
        $q= "SELECT * FROM applyevent WHERE user_ID='$id'";
            ...
            //$check_images= mysqli_num_rows($result);
             ...
             if($result){
              ...
              <div class="overlay">
                ...
                <a href="eventDetailinvoice.php? eventID=<?php echo $row['eventID']  ?>" style="text-decoration:none;"><button>Event Details</button></a>
                </div>
            </div>
          </div>
    <?php  
  ...
  <p class="center">If there are multiple section of same events that because you submitted multiple arts in one event.So downloading invoice from only one section will be enough </p>
