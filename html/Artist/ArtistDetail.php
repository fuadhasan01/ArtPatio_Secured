        ...
        <div class="right">
            ...
            <div class="profileInfo">
                <div class="infoLeft">
                    ...
                    <a href="follow.php? id=<?php echo $id?> " id="follow" style="text-decoration: none; color:white; font-size: 17px; background-color:green; padding:10px 30px; ">Follow</a>
                    <a href="Unfollow.php? id=<?php echo $id?> " id="unfollow"style="text-decoration: none; color:white; font-size: 17px; background-color:red; padding:10px 30px;">Unfollow</a>
                    </div>
