<?php
    ...
    $id= $_SESSION['id'];
    $q2= "SELECT * FROM user_profile WHERE id='$id'";
    $result2 = mysqli_query($conn, $q2);
    $row2 = mysqli_fetch_array($result2);
    $currancy= $row2['currancy'];
    $dp1= $row2['dp'];
 ...
 <nav>
    <div class="nav">
        <div class="left">
            ...
            <span onclick="window.location.href='Artist/artistpage.php'">Home</span>
            <span onclick="window.location.href='Artist/art.php'">Arts</span>
            <span onclick="window.location.href='Artist/Artists.php'">Artists</span>
            <span onclick="window.location.href='Artist/gallery.php'">Gallery</span>
            <span onclick="window.location.href='Artist/event.php'">Events</span>
        ...
        <div class="right">
            ...
            <div style="position: relative;">
                ...
                <a href="Artist/artistprofile.php">Profile</a>
                    <a href="Artist/artistrfav.php">Favourite</a>
                    <a href="Artist/purchasedarts.php">Purchased Arts</a>
                    <a href="Artist/purchasedtickets.php">Purchased Tickets</a>
                    <a href="Artist/uploadTheArt.php">Upload Arts</a>
                    <a href="Artist/withdraw1.php">Withdraw Coin</a>
