        ...
        <div class="right">
            ...
            <div class="profileInfo">
                <div class="infoLeft">
                    ...
                    <a href="follow.php? id=<?php echo $id?> "class=>Follow</a>
                    <a href="Unfollow.php? id=<?php echo $id?> "class=>Unfollow</a>
                    </div>
            ...
            <div class="cardContainer">
                <?php
                 if($check> 0){
                    $q= "SELECT * FROM event WHERE user_id = '$id' ";
                    

                  }
                  else{
                    $q= "SELECT * FROM event WHERE user_id = '$id'limit 3 ";
                    ...
                    if($check_image>0){
                        while($row=mysqli_fetch_array($result)){
                            ...
                            ?>    
                            <div class="card">
                             <img src="banner/<?php echo  $image?>" alt="">
                                <div class="overlay">
                                 <h1><?php echo $eventname?></h1>
                                 <p>$<?php echo $priceTicket ?></p>
