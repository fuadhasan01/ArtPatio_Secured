...
<div class="container">
    ...
    <div class="details">
       <h1><?php echo $eventname?></h1> 
        ...
        <p><span>Status: </span><span style="color:red;"><?php if($buy==1){echo $statement;}else{echo $statement;} ?></span></p>
        
        <div>
            <a href="#" class="purchaseBtn"><button>Purchase Ticket</button></a>
...
<script>
    ...
    purchaseBtn.addEventListener('click',() =>{
        ...
        if(<?php echo $x?> == 0 && <?php echo $_SESSION['currancy'] ?> >= <?php echo $price?>){
            eventPopup.style.display = 'block';
        }
        else if(<?php echo $_SESSION['currancy'] ?> < <?php echo $price?>){
