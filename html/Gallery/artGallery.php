...
<body>
    ...
    <h1 style="text-align: center; color: White; margin:0;"><?php echo $datetime?></h1>
      <div class="exit"><button onclick="window.location.href='artistpage.php'">Exit From the Gallery</button></div>
      <div>
        ...
        if($check_images>0){
          while($row2 = mysqli_fetch_array($result2)){
            ...
            <!-- <button class="art-detail">Art Detail</button> -->
      ...
      <div class="detail">
        <h1>Art Title:<?php echo $title?></h1>
