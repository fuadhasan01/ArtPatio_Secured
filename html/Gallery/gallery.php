...
<main>
  ...
  <div class="container">
    <?php
        ...
        $query= "SELECT * FROM user_profile WHERE category='gallery' and id!='".$_SESSION['id']."' ";
        ...
        if($check_images>0){
            while($row=mysqli_fetch_array($result)){
              ...
              <div class="overlay">
                <h1>Name: <?php echo  $gallery  ?></h1>
                <div style="width: fit-content; margin: auto">
                <a href="galleryDetails.php? id=<?php echo $id?>" style="text-decoration:none;"><button>Gallery Details</button></a>
                </div>
            </div>
          </div>
        <?php  
