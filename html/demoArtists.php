...
<main>
  ...
  <div class="container">
          ...
          <div class="card">
              <img src="../hmtl/userDP/54724.jpg" alt="">
              <div class="overlay">
                <h1>Name: Fuad Hasan</h1>
                <div style="width: fit-content; margin: auto">
                <a href="" style="text-decoration:none;"><button>Artist Details</button></a>
                </div>
            </div>
          </div>

          <div class="card">
              <img src="../hmtl/userDP/607877.jpg" alt="">
              <div class="overlay">
                <h1>Name: Fuad Hasan</h1>
                <div style="width: fit-content; margin: auto">
                <a href="" style="text-decoration:none;"><button>Artist Details</button></a>
          ...
          <div class="card">
              <img src="../hmtl/userDP/DSC_0383.JPG" alt="">
              <div class="overlay">
                <h1>Name: Fuad Hasan</h1>
                <div style="width: fit-content; margin: auto">
                <a href="" style="text-decoration:none;"><button>Artist Details</button></a>
          ...
          <div class="card">
              <img src="../hmtl/userDP/kabir.jpg" alt="">
              <div class="overlay">
                <h1>Name: Fuad Hasan</h1>
                <div style="width: fit-content; margin: auto">
                <a href="" style="text-decoration:none;"><button>Artist Details</button></a>
          ...
          <div class="card">
              <img src="../hmtl/userDP/WhatsApp Image 2023-04-14 at 12.42.09 AM.jpeg" alt="">
              <div class="overlay">
                <h1>Name: Fuad Hasan</h1>
                <div style="width: fit-content; margin: auto">
                <a href="" style="text-decoration:none;"><button>Artist Details</button></a>
          ...
          <div class="card">
              <img src="../hmtl/userDP/gallery2.jpg" alt="">
              <div class="overlay">
                <h1>Name: Fuad Hasan</h1>
                <div style="width: fit-content; margin: auto">
                <a href="" style="text-decoration:none;"><button>Artist Details</button></a>
