        ...
        <div class="container">
            <div class="left">
                <div class="cart">
                    ...
                    <div>
                        <button type="submit" name="request1" id="500">Price:650৳ Buy Now</button>
                    </div>
                </div>
                <div class="cart">
                    <div>
                    ...
                    <div>
                    <button type="submit" name="request2" id="1000">Price:1100৳ Buy Now</button>
                    </div>
                </div>
                <div class="cart">
                    <div>
                    ...
                    <div>
                    <button type="submit" name="request3" id="1500">Price:1650৳ Buy Now</button>
                    </div>
                </div>
                <div class="cart">
                    <div>
                    ...
                    <div>
                    <button type="submit" name="request4" id="2000">Price:2200৳ Buy Now</button>
                    </div>
                </div>
            </div>
            <div class="right">
