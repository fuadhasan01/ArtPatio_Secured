...
<main>
  ...
  <div class="search-area">
      <span class="search-icon" style="padding-top: 5px;"><i class="fas fa-search" style="color: #b1b1b1;"></i></span>
      <input type="search" name="search" value="<?php if(isset($_GET['search'])){echo $_GET['search'];}?>"class="form-control"  placeholder="Search">
  </div>
  </form>
</main> -->
<main class="" >
        ...
        <div>
            <h1><?php echo $_SESSION['name'] ?>'s Purchased Section</h1>
  ...
  <div class="container">
    ...
    <?php
         $userid = $_SESSION['id'];
         $query="SELECT * FROM arts where owner=$userid && status = 'Sold'";
          ...
          if($check_images>0){
           ...
           ?>   
              ...
              <div class="overlay">
                ...
                <a href="art_Status.php? artID=<?php echo $row['artID']  ?>" style="text-decoration:none;"><button>Art Status</button></a>
                </div>
            </div>
          </div>
    <?php
