...
if (!isset($_SESSION['email']) || !hasAccess($_SESSION['category'], 'Admin')) {
                    ...
                    <div class="card-body">
                        <table class="table table-bordered text-center">
                            ...
                            ?>
                                ...
                                <td><a href="rechargeORwithdraw.php? approve=<?php echo $id; ?>" class="btn btn-primary" id="approveRW">Approve</a></td>    
                                <td><a href="decline.php? dltid=<?php echo $id; ?>" class="btn btn-danger" id="declineRW">Decline</a></td>
