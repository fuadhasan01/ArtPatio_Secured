<?php
     ...
     include 'access_control.php'; // Adjust the path as necessary
    // Check if the user is logged in and has the right category
    if (!isset($_SESSION['email']) || !hasAccess($_SESSION['category'], 'Customer')) {
        header('Location: unauthorized.php'); // Redirect to unauthorized page if access is denied
        exit;
    }
  ...
  <nav>
    <div class="nav">
      ...
      <a href="index4.php"> <img src="6.png" alt=""></a>
            ...
            <span onclick="window.location.href='art.php'" id="arts">Arts</span>
            <span onclick="window.location.href='Artists.php'">Artists</span>
            <span onclick="window.location.href='gallery.php'">Gallery</span>
            <span onclick="window.location.href='event.php'" id="events">Events</span>
        ...
        <div class="right">
            ...
            <a href="addFunds.php"  style="text-decoration:none;" id="funds"><span>$<?php echo $currancy ?></span></a>
