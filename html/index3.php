 ...
 <nav>
    <div class="nav">
        <div class="left">
            ...
            <span onclick="window.location.href='Gallery/gallerypage.php'">Home</span>
            <span onclick="window.location.href='Gallery/art.php'">Arts</span>
            <span onclick="window.location.href='Gallery/Artists.php'">Artists</span>
            <span onclick="window.location.href='Gallery/gallery.php'">Gallery</span>
            <span onclick="window.location.href='Gallery/event.php'">Events</span>
        ...
        <div class="right">
            ...
            <div style="position: relative;">
                ...
                <a href="Gallery/galleryprofile.php">Profile</a>
                    <!-- <a href="galleryfav.php">Favourite</a>
                    <a href="purchasedarts.php">Purchased Arts</a> -->
                    <a href="Gallery/requests.php">Requests</a>
                    <a href="Gallery/eventPosting.php">Event Post</a>
                    <a href="Gallery/withdraw1.php">Withdraw Coin</a>
                    <a href="Gallery/purchasedarts.php">Purchased Arts</a>
                    <a href="Gallery/galleryfav.php">Favourite</a>
